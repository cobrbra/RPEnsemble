...
#'
#' @description Chooses the best projection based on an estimate of the validation error of the classifier with training data (XTrain, YTrain), the estimation method counts the number of errors made on the validation set (XVal, YVal). Produces predictions on validation and test sets.
#'
...
#' A sample splitting version of RPChooseA
#'
